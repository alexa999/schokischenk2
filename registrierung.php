...
<body class="featured-slide2">
  ...
  <div class="w-form">
    <form class="w-clearfix" data-name="Email Form" id="email-form" method="post" name="email-form" action="index.php">
...
if (isset ($_POST["submit"])){
    ...
    $_SESSION["email"] = $email;
     var_dump($_POST);
    $sql="CREATE Kunde Vorname='".$vorname."',Nachname='".$nachname."',Adresse='".$strasse."', Email='".$email."'";
