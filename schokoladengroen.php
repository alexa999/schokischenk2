...
<html data-wf-page="5876621196d238082b00976c" data-wf-site="5870e9af48ff79596f35ed23">
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <?php
if( isset( $_GET["groesse"] ) && !empty( $_GET["groesse"] ) ) {
  $groesse = $_GET["groesse"];
  $sql = "SELECT * FROM Gut WHERE schokoladengroesse LIKE '" . $groesse . "'";
  ...
  <div class="sectionchocolatesize">
    <div class="w-container" style="<?php if(count($alleSchokoladen) < 3 ) { echo 'margin-bottom:15%;'; } ?>">
